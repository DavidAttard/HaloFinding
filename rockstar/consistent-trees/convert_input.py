# convert_input.py
# Slightly edited version of the the one found in consistent-trees.
# Also provides the fMhires field generated by AHF
...
snap_list = []
with open('./snaplist.txt', 'r') as f:
    for line in f:
        snap_list.append(line.strip('\n').replace('AHF_particles', 'AHF_halos'))
...
#ID DescID Mass Vmax Vrms Radius Rs Np X Y Z VX VY VZ JX JY JZ Spin fMhires
